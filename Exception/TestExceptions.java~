...
//			FileInputStream fis = new FileInputStream("C:/TestJava/test/src/com/tcs/Exceptions/testfile.txt");
			FileInputStream fis = new FileInputStream("//172.18.65.9/ILP-OpenStore/testfile.txt");
